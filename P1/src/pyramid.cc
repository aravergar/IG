...
//~ Pyramid::Pyramid(float height = 10.0f, float radius = 4.0f, int faces_val = 3){
Pyramid::Pyramid(float height, float radius, int faces_val){
	...
	//~ mesh->vertices = (Tuple3r*) malloc(5);
	//~ mesh->triangles = (Tuple3n*) malloc(6);
	...
	//~ mesh->vertices[r]esize(this->faces+2);
	//~ mesh->triangles[r]esize(this->faces*2);
